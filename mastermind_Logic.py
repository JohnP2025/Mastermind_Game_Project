...
def main():
    ...
    colors=["Pink", "Orange", "Yellow", "Green", "Cyan", "Indigo"] # initialize colors
...
def new_game(colors, maxGuesses, seqLength): # initializes game data and returns data dict
    sequence = random.choices(colors, k=seqLength)
    guesses = 0
    maxGuesses = maxGuesses
    data = {"colors": colors, "sequence": sequence, "guesses": guesses, "maxGuesses": maxGuesses, "sequence":sequence}
    return data
